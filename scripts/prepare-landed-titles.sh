...
if [ "${GAME}" == "CK2" ] || [ "${GAME}" == "CK2HIP" ]; then
    ...
    replace-cultural-name "egyptian_arabic" "Arabic_Egyptian"
    ...
    replace-cultural-name "maghreb_arabic" "Arabic_Maghrebi"
...
if [ "${GAME}" == "CK3" ] || [ "${GAME}" == "CK3IBL" ] || [ "${GAME}" == "CK3MBP" ] || [ "${GAME}" == "CK3TFE" ]; then
    ...
    replace-cultural-name "egyptian" "Arabic_Egyptian"
    ...
    replace-cultural-name "maghrebi" "Arabic_Maghrebi"
...
if [ "${GAME}" == "CK3TFE" ]; then
    ...
    replace-cultural-name "jewish" "Arabic_Hejazi_Old"
