...
function normalise-name() {
    ...
    TRANSLITERATED_NAME=$(transliterate-name "${LANGUAGE_CODE}" "${NAME}" | \
        ...
        sed \
            ...
            -e 's/^\(Āltepētl\|Bahasa\|Burg\|Cathair\|Comitatu[ls]\|Daerah\|Dorerit\|Emirlando\|Eparchía\|Glṓssa\|Glùm Paā-săā\|G[e]*m[ei][e]*n[t]*[ae]\|Gr[ao][a]*f\(ija\|lando\|skap\)\|Grad\|Gurun\|Hạt\|Horad\|[Hh]ra[bf]stv[aí]\|Huyện\|[Ii]dioma\|Ìpínlẹ̀\|[Jj]ęzyk\|K'"'"'alak'"'"'i\|Kástro\|Kêr\|Kerajaan\|Komēteía\|Kontelezh\|Kreis\|Kwáāen\|Królestwo\|[Ll][eií][mn][g]*[bu]*a\|M[e]*ch[e]*wz\|Mqāṭʿẗ\|Municipiu[lmo]\|Okręg\|Opština\|Oraș\|Paā-săā\|Pasiolak\|Prikhod\|Qarku\|Rát\|Sa mạc\|Schloss\|Stadt\|Swydd\|ti\|[Tt]iếng\|[Tt]yrt\|[Vv]ioska\|[VvWw]il[l]*a\(yah\)*\|Vilojati\|Vostraŭ\|Wikang\|Zamok\|Zıwanê\) //g' \
