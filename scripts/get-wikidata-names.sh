...
function normalise-name() {
    ...
    TRANSLITERATED_NAME=$(transliterate-name "${LANGUAGE_CODE}" "${NAME}" | \
        ...
        sed \
            ...
            -e 's/^\(Āltepētl\|Bahasa\|Burg\|Cathair\|Comitatu[ls]\|Daerah\|Dorerit\|Glṓssa\|Glùm Paā-săā\|Emirlando\|Eparchía\|G[e]*m[ei][e]*n[t]*[ae]\|Graafskap\|Graflando\|Gurun\|Hạt\|Horad\|[Hh]ra[bf]stv[aí]\|Huyện\|[Ii]dioma\|Ìpínlẹ̀\|[Jj]ęzyk\|K'"'"'alak'"'"'i\|Kástro\|Kêr\|Kerajaan\|Komēteía\|Kontelezh\|Kreis\|Kwáāen\|Królestwo\|[Ll][eií][mn][g]*[bu]*a\|Mchwz\|Mqāṭʿẗ\|Municipiu[lmo]\|Okręg\|Opština\|Oraș\|Paā-săā\|Pasiolak\|Prikhod\|Qarku\|Rát\|Sa mạc\|Schloss\|Stadt\|Swydd\|ti\|[Tt]iếng\|[Tt]yrt\|[VvWw]il[l]*a\(yah\)*\|Vilojati\|Vostraŭ\|Wikang\|Zamok\|Zıwanê\) //g' \
