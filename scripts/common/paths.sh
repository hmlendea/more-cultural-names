...
Vic3_VANILLA_COUNTRIES_FILE="${VANILLA_FILES_DIR}/Vic3_countries.txt"
Vic3_VANILLA_STATES_FILE="${VANILLA_FILES_DIR}/Vic3_states.txt"
Vic3_VANILLA_HUBS_FILE="${VANILLA_FILES_DIR}/Vic3_hubs.txt"
