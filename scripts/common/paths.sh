...
HOI4RT56_DIR="${STEAM_WORKSHOP_HOI4_DIR}/820260968"
HOI4RT56_TAGS_DIR="${HOI4RT56_DIR}/common/country_tags"
HOI4RT56_STATES_DIR="${HOI4RT56_DIR}/history/states"
HOI4RT56_LOCALISATIONS_DIR="${HOI4RT56_DIR}/localisation/english"
HOI4RT56_VANILLA_PARENTAGE_FILE="${VANILLA_FILES_DIR}/hoi4rt56_parentage.txt"
