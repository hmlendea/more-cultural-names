...
function normalise-name() {
    ...
    local COMMON_PATTERNS="${P_ANCIENT}\|${P_CASTLE}\|${P_CATHEDRAL}\|${P_CITY}\|${P_COUNTRY}\|${P_DISTRICT}\|${P_GMINA}\|${P_ISLAND}\|${P_NATIONAL_PARK}\|${P_PREFECTURE}\|${P_PROVINCE}\|${P_REGION}\|${P_STATE}"
