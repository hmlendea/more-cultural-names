...
function normalise-name() {
    ...
    local P_CASTLE="[CcGgKk]a[i]*[sz][lt][ei]*[aál][il]*[eoulmn]*[a]*\|Dvorac\|[Kk]alesi\|Zam[ao][gk][y]*"
    ...
    local NORMALISED_NAME=$(echo "${TRANSLITERATED_NAME}" | \
        ...
        sed \
            ...
            -e 's/^[Ll][ei]ngua //g' \
            -e 's/^D '"${P_REGION}"' //g' \
            -e 's/^\('"${P_ANCIENT}"'\|'"${P_CASTLE}"'\|'"${P_CATHEDRAL}"'\|'"${P_GMINA}"'\|'"${P_REGION}"'\)\s\s*\(\([dl]*[aeiou]*[l]*\|of\|ng\|[Tt]a\|[Tt]o[uy]\|w\)[ '"'"']\)*//g' \
            -e 's/^\(Ar[c]*hip[eè]la\(g[ou][l]*\)*\|Aut[oó]noma\|[Cc]ollegio\|[CcKk]omita[a]*t\(us\)*\|[Dd][eήḗ]mos\|[Dd]i[eoó]c[eè][sz][eij][as]*\|[Dd][ei]part[ai]*ment[ou]*[l]*\|[Dd][ií]mos\|[Dd][iy]str[eiy][ckt]*[akt][eouy]*[as]*\|[Ee]*[SsŠš]ta[dtu][eou]*[l]*\|[Ff]ort[e]*\|[GgHh]rad\|[Gg]r[aoó][a]*f\(ov\)*\(ija\|lando\|s\(ch\|k\)a\(ft\|p\)\|stvo\)\|[Ii][n]*[s]*[u]*l[l]*[ae]\|Jangwa\|[Kk][eoö]ni[n]*[gk]r[e]*[iy][cej]*[hk]\\|[Kk][o]*r[aáo]l[io]vstv[iío]\|[Mm][ou][u]*nt[aei]*\([gi][ln][e]*\)*\|Municipi\(u[lmo]\)*\|N[iío][ms][ío][s]*\|[Oo]kr[aeęo][zž]*[gj][e]*\|[Pp]ar[r]*o[i]*\(cc\|q\|ss\)\(e\|[hu]ia\)\|[Pp][ao][luŭ][uv]ostr[ao][uŭv]\|[Pp][eé]n[iíì][n]*[csz][ou][lł][aāe]\|Periferi[j]*a\|[Pp][’]*r[ao][bpvw][ëií][nñ][t]*[csz]*[eiíjoy]*[aez]*\|[Pp]r[aäeé]fe[ck]t[uúū]r[ae]*\|[Rr]egatul\|[Rr]eialme\|R[iīí][fo]\|Sultanat\) \(\([dl]*[aeiou]*[l]*\|of\|ng\|[Tt]a\|[Tt]o[uy]\|w\)[ '"'"']\)*//g' \
            -e 's/^\(Āltepētl\|Ardal\|Bahasa\|Bán đảo\|Bldīẗ\|Bogserbåten\|Bundestagswahlkreis\|Bwrdeistref\|Burg\|Cathair\|Comitatu[ls]\|Daerah\|Ḍāḥīẗ\|Dorerit\|Drevna\|Emirlando\|Eparchía\|Fiume\|G[e]*m[ei][e]*n[t]*[ae]*\|Glṓssa\|Glùm Paā-săā\|Grad\|Gurun\|Hrafstvo\|Hạt\|Higashi\|Horad\|[Hh]ra[bf]stv[aí]\|Huyện\|[Ii]dioma\|İlçesi\|Ìpínlẹ̀\|Iqlīm\|Is[ṭt][a]*\|Isŭt’ŭ\|[Jj]ęzyk\|Kàēyt Bpòk Kraāwng\|K'"'"'alak'"'"'i\|Kástro\|Kêr\|Kerajaan\|Komēteía\|Kongedømmet\|Kontelezh\|Kraljestvo\|Kreis\|Kwáāen\|Kr[aó]l[j]*e\(stwo\|vina\)\|Landschaft\|Lâu đài\|[Ll][eií][mn][g]*[bu]*a\|Lien\|Lutherstadt\|Mâāe Náām\|Markgrafschaft\|Mdīnẗ\|M[e]*ch[e]*wz\|Memlekt\|Mḥāfẓẗ\|Miedźje\|Mon-ton\|Mqāṭʿẗ\|Ná[-]*kaāwn\|Nhr\|O[bp]\(s[hj]\|š\)tina\|Okres\|Oraș\(ul\)*\|Óros\|Paā-săā\|Pasiolak\|Pentadbiran\|Półwysep\|Potamós\|Prikhod\|Pulau\|Pustynia\|Qarku\|Raka\|Rát\|Râāt-chá-aā-naā-zhàk\|[Rr]âul\|Sa mạc\|Schloss\|Sir\|Sông\|Stadt\(kreis\)*\|Sungai\|Swydd\|ti\|[Tt]iếng\|Tỉnh\|[Tt]yrt\|Ūlāīẗ\|[Vv]ioska\|[VvWw]il[l]*a\(yah\)*\|Vilojati\|Vostraŭ\|Vương quốc\|Wikang\|Zam[eo]k\|Zhang Wàt\|Z[iı]wanê\) \(\([Tt]o[uy]\|w\) \)*//g' \
