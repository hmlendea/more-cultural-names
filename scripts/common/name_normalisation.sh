...
function normalise-name() {
    ...
    local NORMALISED_NAME=$(echo "${TRANSLITERATED_NAME}" | \
        ...
        sed \
            ...
            -e 's/^[Ll][ei]ngua //g' \
            -e 's/^D Regioon //g' \
            -e 's/^\([CcKk]a[i]*st[ei]*[al][l]*[eoulm]*\|[Dd]i[eoó]c[eè][sz][eij][as]*\|[Dd][iy]str[eiy][ckt]*[akt][eouy]*[as]*\|[Ee]*[SsŠš]ta[dtu][eou]*[l]*\|[Ff]ort[e]*\|[Gg]r[aoó][a]*f\(ov\)*\(ija\|lando\|skap\|stvo\)\|[Ii][n]*[s]*[u]*l[l]*[ae]\|Jangwa\|Kongedømmet\|[Mm][ou][u]*nt[ae][gi][ln][e]*\|Municipi\(u[lmo]\)*\|[Oo]kr[aeęo][zž]*[gj][e]*\|[Pp]ar[r]*o[i]*\(cc\|q\|ss\)\(e\|[hu]ia\)\|[Pp]en[ií]n[cs]ul[aā]\|[Pp][’]*r[ao][bpvw][ëií][nñ][t]*[csz]*[eiíjoy]*[aez]*\|[Pp]r[eé]fe[ckt]t[uū]r[ae]\|[Rr]eialme\|Sultanat\) \(\([dl]*[aeiou]*[l]*\|of\|ng\)[ '"'"']\)*//g' \
            -e 's/^\(Āltepētl\|Ardal\|Bahasa\|Bán đảo\|Bldīẗ\|Bogserbåten\|Burg\|Cathair\|Comitatu[ls]\|Daerah\|Dorerit\|Emirlando\|Eparchía\|Fiume\|G[e]*m[ei][e]*n[t]*[ae]*\|Glṓssa\|Glùm Paā-săā\|Grad\|Gurun\|Hạt\|Higashi\|Horad\|[Hh]ra[bf]stv[aí]\|Huyện\|[Ii]dioma\|Ìpínlẹ̀\|Iqlīm\|Is[ṭt][a]*\|Isŭt’ŭ\|[Jj]ęzyk\|K'"'"'alak'"'"'i\|Kástro\|[Kk][eoö]ni[n]*[gk]r[e]*[iy][cej]*[hk]\|Kêr\|Kerajaan\|Komēteía\|Kontelezh\|Kraljestvo\|Kreis\|Kwáāen\|Kr[aó]l[j]*e\(stwo\|vina\)\|[Ll][eií][mn][g]*[bu]*a\|Lutherstadt\|M[e]*ch[e]*wz\|Memlekt\|Mon-ton\|Mqāṭʿẗ\|O[bp]\(s[hj]\|š\)tina\|Oraș\|Paā-săā\|Pasiolak\|Pentadbiran\|Potamós\|Prikhod\|Pustynia\|Qarku\|Raka\|Rát\|Râāt-chá-aā-naā-zhàk\|[Rr]âul\|R[iīí][fo]\|Sa mạc\|Schloss\|Sir\|Stadt\(kreis\)*\|Swydd\|ti\|[Tt]iếng\|Tỉnh\|[Tt]yrt\|Ūlāīẗ\|[Vv]ioska\|[VvWw]il[l]*a\(yah\)*\|Vilojati\|Vostraŭ\|Vương quốc\|Wikang\|Zamok\|Zhang Wàt\|Z[iı]wanê\) //g' \
            ...
            -e 's/^\(Bisbat\|Bishopric\|\([CcÇçSs]\|Tz\)[eiy][uv]*[dt]*[aáàæ][dt]*[e]*[a]*\|[CcSs]\(ee\|i\)[t]*[aàey]\|[Cc]h[aâ]teau\|[CcKk]o[mn][dt]\(a[dt][o]*\|[eé]\)\|[CcKk][aāo]*[uv]*[nṇ][tṭ][iīy][e]*\|Dakbayan\|Dēmokratía\|[Dd][eé]part[aei]m[ei]*nt[ou]*[l]*\|[Dd][eéi][sz][iy]*er[tz][ho]*\|Fort\(aleza\|ress\)\|[JjŽž]ud[iz]*e[ctțţ]\(ul\)*\|Kaharian\|Kingdom\|M[a]*ml[u]*k[a]*ẗ\|Parish\|Pr[ei]n[cgs][ei]p[aáà][dt]*[eou]*\|[Rr]e[gģhx][ij]*[oóu]n*i*[aes]*\|[Rr][eo][giy][an][eou][m]*[e]*\|R[ei][s ]*p[auüùú]b[b]*l[ií][ck][ck]*\([ai]\|en\|i\)*\|[Ss]hahrest[aā]n\|State\|Thành\|[Tt][h]*[eé]ma\|[Tt]zountéts\|[VvWw]il[l]*[ae]\(ya\)*\|Xian\) \('"'"'e \|d'"'"'\|[dsty][aeiîu][l]* \|[eë]d \|han \|ng \|[t]*[Oo][fu]* \|phố \)*//g' \
            \
            -e 's/\(.\)\(bjerget\|shān\|sŏng\)$/\1/g' \
            -e 's/[ ’-]\([Aa]dası\|AG\|[Aa]imag\|[Aa]irurando\|aju\|alue\|[Aa]ñcala\|apskritis\|[Bb]ar[ou]n[iy][am]*[u]*\|[Bb]hasa\|[Bb]ibhāga\|Bikéyah\|[Bb]isped[øo]m[m]*e\|[Bb]ölgesi\|[Cc]alabro\|[Cc]astle\|çayı\|Chê\|Chhī\|Chibang\|Chiu\|[Cc]hū-tī\|Cit[t]*[aày]\|[CcKk][aāo]*[uv]*[nṇ][tṭ]\([iīy]\|lu[gğ]u]\)\|[cs]h[h]*[ìī]\|[Cc]hiku\|Çölü\|[Cc]omitatus\|Cumhuriyeti\|[Dd]a[gğ][iı]\|[Dd]ǎo\|dar[ij]a\|[Dd]esert\|Dhāma\|Durga\|Dzongkhag\|Eḍāri\|[Ee]na\|[Ee]rusutaa\|[Ee]yaleti\|[Ff]örsamling\|[Ff]ort[e]*\|[Gg]aṇarājya\|[Gg]awa\|gielda\|[Gg]o\|[Gg]ōng[ -][Hh]é[ -][Gg]uó\|[Gg]overnorate\|[Gg]rad[ŭ]*\|grubu\|guovlu\|Hahoodzo\|hálvoyggin\|Hantou\|He\|Hyŏn\|[Ii]ngurando\|[Jj]ach'"'"'a\|[Jj]anarajaya\|jõgi\|[Jj]ou\|[Jj][iù]n\|jūnōu\|[Kk]a [KkQq]ila\|ǩalaḥy\|[Kk]alāpaya\|[Kk]alni\|Kang\|Kàēyt Brì Hăān Pí Sàēyt\|[Kk]àu-khu\|ke[e]*l['"'"']*\|[Kk]hiung[ -][Ff]ò[ -][Kk]oet\|[Kk]örzet\|\|[Kk]ōṭṭai\|khoig\|[Kk]hot\|[Kk]hu\|[Kk][iy][i]*l\|Kilisesi\|Kingdom\|[Kk]o[aā]n\|[Kk]onderria\|község\|[Kk]rallığı\|[Kk]shetr\|Kūn\|Kyouku\|Kyouwa Koku\|[Ll]anguage\|[Ll]ingvo\|linn\|maak[ou]n[dt]a*\|[Mm]achi\|[Mm]ahal[iı]\|Mākāṇam\|Maṇḍalam\|Marubhūmi\|Māvaṭṭam\|[Mm]arz\|megye\|mhuriyeti\|[Mm]oḻi\|[Mm]ovy\|[Mm]unicipality\|Mura\|Nadi\|Nagar\(am\)*\|Nakaram\|Nehri\|osariik\|[Oo]ukoku\|pagasts\|[Pp]akuti\|[Pp]aḷāta\|Pālaivaṉam\|[Pp]il[i]*s\|qalasy\|qəsri\|qraflığı\|[Rr]ajonas\|[Rr]e[gh]i[j]*on\|rén\|[Rr]e[s]*publi[ck][a]*\(ḥy\)*\|[Rr]iver\|[SsŠš]aar[iy]*\|Sa[bm]ak[u]*\|[Ss]agrapo\|[sșş][eə]hristan[iı]\|[Ss][h]*i\|Shikyou Ryou\|[Ss][ho][aā]-[bm][òô͘]*\|[Ss]hou\|Siti\|Shuu\|síksá\|sivatag\|slott\|so\(g\|cke\)n\|sritis\|Sṳ\|sultan\(at[e]*\|lığı\)\|suohkan\|suyu\|tamaneɣt\|tartomány\|[Tt][eē]\|tele\|[Tt]hi-[Kk]hî\|tillari\|[Tt]oshi\|[Tt]ou\|Town\|tu’begi\|[Uu]da\(bno\|lerria\)\|vald\|[Vv]ibhāg\|Vương quốc Hồi giáo\|[Ww]amani\|[Ww]áng[ -][Gg]uó\|Wangguk\|[Xx]i[aàā]n[g]*\|yǔ\|zh[ēō]*[nu]\|[ZzŽž][h]*ude[ct]s[i]*\|zōng\)$//g' \
            -e 's/[ ’-]\([CcKk]o[ou]*nt\(ae\|luğu\|y\)\|[Dd]epart[a]*ment\(as\)*\|[Dd][iy]str[eiy][ckt]*[akt][eouy]*[as]*\|[EeIi]*[Ss][h]*t[’]*a[dt][’]*[eiou]\|[GgQq]r[aā]f[l]*[iı]\(ı\|ste\)\|\|[Jj][eēi]l[hl]*[aāeo][a]*\|[Mm]a[nṇ][dḍ]al\(a[mṁ]\)*\|P[aā][i]*ri\(ṣ\|sh\)\|[Mm]in[tţ]a[kq]at*\|[Pp]en[ií]n[cs]ul[aā]\|[Pp]ii\(r\|skop\)kond\|[Pp]lanin[ai]\|[Pp]r[a]*d[eē][sś][h]*[a]*\|[Pp]r[aā]*nt[y]*[a]*\([ṁy][a]*\)*\|[Pp][’]*r[aāou][bpvw][ëií][nñ][t]*[csz]*[eėiíjoy]*[aeėsz]\|[Pp]r[eé]fe[ckt]t[uū]r[ae]\|[Pp]rja[a]*st[t]*a[a]*k\|[Pp]u[u]*[l]*s[s]*a[al][ar]\|[Rr]e[gģh]i[j]*\([oóu]n*[ei]*[as]*\|st[aā]n\)\|[Rr]eialme\|[Rr][e]*[iī]c[eh]\|[Rr]esp[uúy][’]*bli[’]*[ck][ai]\(sy\)*\|[Ss]h[eě]ng\|[Ss][h]*t[’]*at[’]*[ei]\|[Vv]il[aā][jy]\(eti\|s\)\)$//g' \
            -e 's/ [KkCc]om*un*[ea]*$//g' \
            -e 's/ \(Ken\|Koān\)$//g' \
            \
            -e 's/^Hl\. /Heilige /g' \
